...
def main():
    ...
    eval_examples, eval_data = load_and_cache_defect_data(args, args.eval_filename, pool, tokenizer, 'valid',
                                                         False)
    test_examples, test_data = load_and_cache_defect_data(args, args.test_filename, pool, tokenizer, 'test',
                                                         False)
