...
def evaluate(args, model, eval_examples, eval_data, write_to_pred=False):
    ...
    if write_to_pred:
        ...
        with open(os.path.join(args.output_dir, "checkpoint-best-acc" ,"test_pred.pkl"), 'wb') as f:
            ...
            for step, batch in enumerate(bar):
                ...
                if (step + 1) % save_steps == 0 and args.do_eval:
                    ...
                    if eval_acc > best_acc:
                        ...
                        not_acc_inc_cnt += 1
                        logger.info("F1 does not increase for %d epochs", not_acc_inc_cnt)
