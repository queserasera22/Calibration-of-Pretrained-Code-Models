...
def evaluate(args, model, eval_data, test_data):
    ...
    save_path = os.path.join(os.path.dirname(args.load_model_path), 'ts_test')
...
def main():
    ...
    eval_examples, eval_data = load_and_cache_classification_data(args, args.eval_filename, pool, tokenizer, '{}_valid'.format(args.dataset_name),
                                                         False)
    test_examples, test_data = load_and_cache_classification_data(args, args.test_filename, pool, tokenizer, '{}_test'.format(args.dataset_name),
                                                         False)
